    ...
    def train(self, dataset):
        ...
        while True: 
            for x, y in dataset.iterate_once(self.batch_size):
                ...
                self.b1.update(grad[1], -0.01)
                self.w2.update(grad[2], -0.01)
...
class DigitClassificationModel(object):
    ...
    def __init__(self):
        ...
        x_dimen = 784
        y_dimen = 10
        self.w1 = nn.Parameter(x_dimen,100)
        self.b1 = nn.Parameter(1,100)
        self.w2 = nn.Parameter(100,y_dimen)
        self.b2 = nn.Parameter(1,y_dimen)
...
class LanguageIDModel(object):
    ...
    def __init__(self):
        ...
        "*** YOUR CODE HERE ***"
        self.batch_size = 1
        x_dimen = self.num_chars
        y_dimen = len(self.languages)
        
        self.w = nn.Parameter(x_dimen,100)
    ...
    def run(self, xs):
        ...
        for i in range(1,len(xs)):
            z = nn.Add(nn.Linear(xs[i], self.w), nn.Linear(z, self.w1))
    ...
    def train(self, dataset):
        ...
        while True: 
            for xs, y in dataset.iterate_once(self.batch_size):
                ...
                grad = nn.gradients(loss,[self.w,self.w1,self.w2])
                self.w.update(grad[0], -0.01)
                self.w1.update(grad[1], -0.01)
                self.w2.update(grad[2], -0.01)
